...
class ErrorNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === 'AntiPatternInc\\Saasus\\Sdk\\ApiLog\\Model\\Error';
    }
    public function supportsNormalization($data, $format = null, array $context = array()) : bool
    {
        return is_object($data) && get_class($data) === 'AntiPatternInc\\Saasus\\Sdk\\ApiLog\\Model\\Error';
    }
    /**
     * @return mixed
     */
    ...
    {
        return array('AntiPatternInc\\Saasus\\Sdk\\ApiLog\\Model\\Error' => false);
    }
}