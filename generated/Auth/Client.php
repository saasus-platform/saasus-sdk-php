...
class Client extends \AntiPatternInc\Saasus\Sdk\Auth\Runtime\Client\Client
{
    ...
    * @param string $fetch Fetch mode to use (can be OBJECT or RESPONSE)
    * @throws \AntiPatternInc\Saasus\Sdk\Auth\Exception\RequestEmailUpdateBadRequestException
    ...
    */
     ...
     * @param string $fetch Fetch mode to use (can be OBJECT or RESPONSE)
     * @throws \AntiPatternInc\Saasus\Sdk\Auth\Exception\UpdateIdentityProviderBadRequestException
     ...
     * @param string $fetch Fetch mode to use (can be OBJECT or RESPONSE)
     * @throws \AntiPatternInc\Saasus\Sdk\Auth\Exception\UpdateSignInSettingsBadRequestException
    ...
    */
     ...
     * @return null|\Psr\Http\Message\ResponseInterface
     */
    public function revokeToken(?\AntiPatternInc\Saasus\Sdk\Auth\Model\RevokeTokenParam $requestBody = null, string $fetch = self::FETCH_OBJECT)
    {
        return $this->executeEndpoint(new \AntiPatternInc\Saasus\Sdk\Auth\Endpoint\RevokeToken($requestBody), $fetch);
    }
    /**
