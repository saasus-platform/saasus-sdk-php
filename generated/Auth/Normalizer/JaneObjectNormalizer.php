...
if (!class_exists(Kernel::class) or (Kernel::MAJOR_VERSION >= 7 or Kernel::MAJOR_VERSION === 6 and Kernel::MINOR_VERSION === 4)) {
    class JaneObjectNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
    {
        ...
        protected $normalizers = [
            ...
            \AntiPatternInc\Saasus\Sdk\Auth\Model\SaasUsersCount::class => \AntiPatternInc\Saasus\Sdk\Auth\Normalizer\SaasUsersCountNormalizer::class,
            
            \AntiPatternInc\Saasus\Sdk\Auth\Model\SaveSaasUsersCountParam::class => \AntiPatternInc\Saasus\Sdk\Auth\Normalizer\SaveSaasUsersCountParamNormalizer::class,
            
            \AntiPatternInc\Saasus\Sdk\Auth\Model\CreatedSaasUser::class => \AntiPatternInc\Saasus\Sdk\Auth\Normalizer\CreatedSaasUserNormalizer::class,
            ...
            \AntiPatternInc\Saasus\Sdk\Auth\Model\TenantUserCount::class => \AntiPatternInc\Saasus\Sdk\Auth\Normalizer\TenantUserCountNormalizer::class,
            
            \AntiPatternInc\Saasus\Sdk\Auth\Model\SaveTenantUserCountParam::class => \AntiPatternInc\Saasus\Sdk\Auth\Normalizer\SaveTenantUserCountParamNormalizer::class,
            
            \AntiPatternInc\Saasus\Sdk\Auth\Model\SaveTenantUsersCountsParam::class => \AntiPatternInc\Saasus\Sdk\Auth\Normalizer\SaveTenantUsersCountsParamNormalizer::class,
            
            \AntiPatternInc\Saasus\Sdk\Auth\Model\TenantUsersCounts::class => \AntiPatternInc\Saasus\Sdk\Auth\Normalizer\TenantUsersCountsNormalizer::class,
            
            \AntiPatternInc\Saasus\Sdk\Auth\Model\SearchTenantUsersResult::class => \AntiPatternInc\Saasus\Sdk\Auth\Normalizer\SearchTenantUsersResultNormalizer::class,
            
            \AntiPatternInc\Saasus\Sdk\Auth\Model\SearchSaasUsersResult::class => \AntiPatternInc\Saasus\Sdk\Auth\Normalizer\SearchSaasUsersResultNormalizer::class,
            ...
            \AntiPatternInc\Saasus\Sdk\Auth\Model\SaasUserResetPasswordResult::class => \AntiPatternInc\Saasus\Sdk\Auth\Normalizer\SaasUserResetPasswordResultNormalizer::class,
            ...
            \AntiPatternInc\Saasus\Sdk\Auth\Model\UpdateSaasUserSignInIdParam::class => \AntiPatternInc\Saasus\Sdk\Auth\Normalizer\UpdateSaasUserSignInIdParamNormalizer::class,
            ...
            \AntiPatternInc\Saasus\Sdk\Auth\Model\UpdateSaasUserAttributesParam::class => \AntiPatternInc\Saasus\Sdk\Auth\Normalizer\UpdateSaasUserAttributesParamNormalizer::class,
            
            \AntiPatternInc\Saasus\Sdk\Auth\Model\UpdateRoleParam::class => \AntiPatternInc\Saasus\Sdk\Auth\Normalizer\UpdateRoleParamNormalizer::class,
            ...
            \AntiPatternInc\Saasus\Sdk\Auth\Model\RefreshTokenValidity::class => \AntiPatternInc\Saasus\Sdk\Auth\Normalizer\RefreshTokenValidityNormalizer::class,
            ...
            \AntiPatternInc\Saasus\Sdk\Auth\Model\RevokeTokenParam::class => \AntiPatternInc\Saasus\Sdk\Auth\Normalizer\RevokeTokenParamNormalizer::class,
            ...
            \AntiPatternInc\Saasus\Sdk\Auth\Model\StripeCustomer::class => \AntiPatternInc\Saasus\Sdk\Auth\Normalizer\StripeCustomerNormalizer::class,
            
            \AntiPatternInc\Saasus\Sdk\Auth\Model\SignInParam::class => \AntiPatternInc\Saasus\Sdk\Auth\Normalizer\SignInParamNormalizer::class,
            
            \AntiPatternInc\Saasus\Sdk\Auth\Model\SignInResult::class => \AntiPatternInc\Saasus\Sdk\Auth\Normalizer\SignInResultNormalizer::class,
            
            \AntiPatternInc\Saasus\Sdk\Auth\Model\RespondToSignInChallengeParam::class => \AntiPatternInc\Saasus\Sdk\Auth\Normalizer\RespondToSignInChallengeParamNormalizer::class,
            
            \AntiPatternInc\Saasus\Sdk\Auth\Model\RespondToSignInChallengeResult::class => \AntiPatternInc\Saasus\Sdk\Auth\Normalizer\RespondToSignInChallengeResultNormalizer::class,
            
            \AntiPatternInc\Saasus\Sdk\Auth\Model\NewDeviceMetadata::class => \AntiPatternInc\Saasus\Sdk\Auth\Normalizer\NewDeviceMetadataNormalizer::class,
            
            \AntiPatternInc\Saasus\Sdk\Auth\Model\DeviceSecretVerifierConfig::class => \AntiPatternInc\Saasus\Sdk\Auth\Normalizer\DeviceSecretVerifierConfigNormalizer::class,
            
            \AntiPatternInc\Saasus\Sdk\Auth\Model\ConfirmDeviceParam::class => \AntiPatternInc\Saasus\Sdk\Auth\Normalizer\ConfirmDeviceParamNormalizer::class,
            
            \AntiPatternInc\Saasus\Sdk\Auth\Model\ConfirmDeviceResult::class => \AntiPatternInc\Saasus\Sdk\Auth\Normalizer\ConfirmDeviceResultNormalizer::class,
            
            \AntiPatternInc\Saasus\Sdk\Auth\Model\UpdateDeviceStatusParam::class => \AntiPatternInc\Saasus\Sdk\Auth\Normalizer\UpdateDeviceStatusParamNormalizer::class,
        ...
        {
            return [\AntiPatternInc\Saasus\Sdk\Auth\Model\UserInfo::class => false, \AntiPatternInc\Saasus\Sdk\Auth\Model\BasicInfo::class => false, \AntiPatternInc\Saasus\Sdk\Auth\Model\DnsRecord::class => false, \AntiPatternInc\Saasus\Sdk\Auth\Model\AuthInfo::class => false, \AntiPatternInc\Saasus\Sdk\Auth\Model\SaasUser::class => false, \AntiPatternInc\Saasus\Sdk\Auth\Model\SaasUsers::class => false, \AntiPatternInc\Saasus\Sdk\Auth\Model\SaasUsersCount::class => false, \AntiPatternInc\Saasus\Sdk\Auth\Model\SaveSaasUsersCountParam::class => false, \AntiPatternInc\Saasus\Sdk\Auth\Model\CreatedSaasUser::class => false, \AntiPatternInc\Saasus\Sdk\Auth\Model\CreateSaasUserParam::class => false, \AntiPatternInc\Saasus\Sdk\Auth\Model\User::class => false, \AntiPatternInc\Saasus\Sdk\Auth\Model\Users::class => false, \AntiPatternInc\Saasus\Sdk\Auth\Model\TenantUserCount::class => false, \AntiPatternInc\Saasus\Sdk\Auth\Model\SaveTenantUserCountParam::class => false, \AntiPatternInc\Saasus\Sdk\Auth\Model\SaveTenantUsersCountsParam::class => false, \AntiPatternInc\Saasus\Sdk\Auth\Model\TenantUsersCounts::class => false, \AntiPatternInc\Saasus\Sdk\Auth\Model\SearchTenantUsersResult::class => false, \AntiPatternInc\Saasus\Sdk\Auth\Model\SearchSaasUsersResult::class => false, \AntiPatternInc\Saasus\Sdk\Auth\Model\ApiKeys::class => false, \AntiPatternInc\Saasus\Sdk\Auth\Model\UpdateBasicInfoParam::class => false, \AntiPatternInc\Saasus\Sdk\Auth\Model\CreateTenantUserParam::class => false, \AntiPatternInc\Saasus\Sdk\Auth\Model\UpdateTenantUserParam::class => false, \AntiPatternInc\Saasus\Sdk\Auth\Model\UpdateSaasUserPasswordParam::class => false, \AntiPatternInc\Saasus\Sdk\Auth\Model\SaasUserResetPasswordResult::class => false, \AntiPatternInc\Saasus\Sdk\Auth\Model\UpdateSaasUserEmailParam::class => false, \AntiPatternInc\Saasus\Sdk\Auth\Model\UpdateSaasUserSignInIdParam::class => false, \AntiPatternInc\Saasus\Sdk\Auth\Model\RequestEmailUpdateParam::class => false, \AntiPatternInc\Saasus\Sdk\Auth\Model\ConfirmEmailUpdateParam::class => false, \AntiPatternInc\Saasus\Sdk\Auth\Model\UpdateSaasUserAttributesParam::class => false, \AntiPatternInc\Saasus\Sdk\Auth\Model\UpdateRoleParam::class => false, \AntiPatternInc\Saasus\Sdk\Auth\Model\CreateTenantUserRolesParam::class => false, \AntiPatternInc\Saasus\Sdk\Auth\Model\Attribute::class => false, \AntiPatternInc\Saasus\Sdk\Auth\Model\UserAttributes::class => false, \AntiPatternInc\Saasus\Sdk\Auth\Model\TenantAttributes::class => false, \AntiPatternInc\Saasus\Sdk\Auth\Model\SaasId::class => false, \AntiPatternInc\Saasus\Sdk\Auth\Model\Role::class => false, \AntiPatternInc\Saasus\Sdk\Auth\Model\Roles::class => false, \AntiPatternInc\Saasus\Sdk\Auth\Model\Tenant::class => false, \AntiPatternInc\Saasus\Sdk\Auth\Model\TenantDetail::class => false, \AntiPatternInc\Saasus\Sdk\Auth\Model\TenantProps::class => false, \AntiPatternInc\Saasus\Sdk\Auth\Model\PlanReservation::class => false, \AntiPatternInc\Saasus\Sdk\Auth\Model\BillingInfo::class => false, \AntiPatternInc\Saasus\Sdk\Auth\Model\BillingAddress::class => false, \AntiPatternInc\Saasus\Sdk\Auth\Model\Tenants::class => false, \AntiPatternInc\Saasus\Sdk\Auth\Model\UserAvailableTenant::class => false, \AntiPatternInc\Saasus\Sdk\Auth\Model\UserAvailableEnv::class => false, \AntiPatternInc\Saasus\Sdk\Auth\Model\Error::class => false, \AntiPatternInc\Saasus\Sdk\Auth\Model\NotificationMessages::class => false, \AntiPatternInc\Saasus\Sdk\Auth\Model\MessageTemplate::class => false, \AntiPatternInc\Saasus\Sdk\Auth\Model\UpdateNotificationMessagesParam::class => false, \AntiPatternInc\Saasus\Sdk\Auth\Model\IdentityProviders::class => false, \AntiPatternInc\Saasus\Sdk\Auth\Model\IdentityProviderProps::class => false, \AntiPatternInc\Saasus\Sdk\Auth\Model\UpdateIdentityProviderParam::class => false, \AntiPatternInc\Saasus\Sdk\Auth\Model\TenantIdentityProviders::class => false, \AntiPatternInc\Saasus\Sdk\Auth\Model\TenantIdentityProvidersSaml::class => false, \AntiPatternInc\Saasus\Sdk\Auth\Model\UpdateTenantIdentityProviderParam::class => false, \AntiPatternInc\Saasus\Sdk\Auth\Model\IdentityProviderSaml::class => false, \AntiPatternInc\Saasus\Sdk\Auth\Model\SignInSettings::class => false, \AntiPatternInc\Saasus\Sdk\Auth\Model\RefreshTokenValidity::class => false, \AntiPatternInc\Saasus\Sdk\Auth\Model\PasswordPolicy::class => false, \AntiPatternInc\Saasus\Sdk\Auth\Model\DeviceConfiguration::class => false, \AntiPatternInc\Saasus\Sdk\Auth\Model\AccountVerification::class => false, \AntiPatternInc\Saasus\Sdk\Auth\Model\UpdateSignInSettingsParam::class => false, \AntiPatternInc\Saasus\Sdk\Auth\Model\MfaConfiguration::class => false, \AntiPatternInc\Saasus\Sdk\Auth\Model\RecaptchaProps::class => false, \AntiPatternInc\Saasus\Sdk\Auth\Model\IdentityProviderConfiguration::class => false, \AntiPatternInc\Saasus\Sdk\Auth\Model\UpdateEnvParam::class => false, \AntiPatternInc\Saasus\Sdk\Auth\Model\Env::class => false, \AntiPatternInc\Saasus\Sdk\Auth\Model\Envs::class => false, \AntiPatternInc\Saasus\Sdk\Auth\Model\CustomizePages::class => false, \AntiPatternInc\Saasus\Sdk\Auth\Model\CustomizePageProps::class => false, \AntiPatternInc\Saasus\Sdk\Auth\Model\UpdateCustomizePagesParam::class => false, \AntiPatternInc\Saasus\Sdk\Auth\Model\SelfRegist::class => false, \AntiPatternInc\Saasus\Sdk\Auth\Model\CustomizePageSettingsProps::class => false, \AntiPatternInc\Saasus\Sdk\Auth\Model\CustomizePageSettings::class => false, \AntiPatternInc\Saasus\Sdk\Auth\Model\UpdateCustomizePageSettingsParam::class => false, \AntiPatternInc\Saasus\Sdk\Auth\Model\PlanHistory::class => false, \AntiPatternInc\Saasus\Sdk\Auth\Model\PlanHistories::class => false, \AntiPatternInc\Saasus\Sdk\Auth\Model\ClientSecret::class => false, \AntiPatternInc\Saasus\Sdk\Auth\Model\Credentials::class => false, \AntiPatternInc\Saasus\Sdk\Auth\Model\RevokeTokenParam::class => false, \AntiPatternInc\Saasus\Sdk\Auth\Model\AuthorizationTempCode::class => false, \AntiPatternInc\Saasus\Sdk\Auth\Model\CreateSecretCodeParam::class => false, \AntiPatternInc\Saasus\Sdk\Auth\Model\SoftwareTokenSecretCode::class => false, \AntiPatternInc\Saasus\Sdk\Auth\Model\UpdateSoftwareTokenParam::class => false, \AntiPatternInc\Saasus\Sdk\Auth\Model\MfaPreference::class => false, \AntiPatternInc\Saasus\Sdk\Auth\Model\SignUpParam::class => false, \AntiPatternInc\Saasus\Sdk\Auth\Model\ResendSignUpConfirmationEmailParam::class => false, \AntiPatternInc\Saasus\Sdk\Auth\Model\SignUpWithAwsMarketplaceParam::class => false, \AntiPatternInc\Saasus\Sdk\Auth\Model\ConfirmSignUpWithAwsMarketplaceParam::class => false, \AntiPatternInc\Saasus\Sdk\Auth\Model\LinkAwsMarketplaceParam::class => false, \AntiPatternInc\Saasus\Sdk\Auth\Model\Invitation::class => false, \AntiPatternInc\Saasus\Sdk\Auth\Model\Invitations::class => false, \AntiPatternInc\Saasus\Sdk\Auth\Model\CreateTenantInvitationParam::class => false, \AntiPatternInc\Saasus\Sdk\Auth\Model\CreateTenantInvitationParamEnvsItem::class => false, \AntiPatternInc\Saasus\Sdk\Auth\Model\ValidateInvitationParam::class => false, \AntiPatternInc\Saasus\Sdk\Auth\Model\InvitationValidity::class => false, \AntiPatternInc\Saasus\Sdk\Auth\Model\RequestExternalUserLinkParam::class => false, \AntiPatternInc\Saasus\Sdk\Auth\Model\ConfirmExternalUserLinkParam::class => false, \AntiPatternInc\Saasus\Sdk\Auth\Model\CloudFormationLaunchStackLink::class => false, \AntiPatternInc\Saasus\Sdk\Auth\Model\SingleTenantSettings::class => false, \AntiPatternInc\Saasus\Sdk\Auth\Model\UpdateSingleTenantSettingsParam::class => false, \AntiPatternInc\Saasus\Sdk\Auth\Model\StripeCustomer::class => false, \AntiPatternInc\Saasus\Sdk\Auth\Model\SignInParam::class => false, \AntiPatternInc\Saasus\Sdk\Auth\Model\SignInResult::class => false, \AntiPatternInc\Saasus\Sdk\Auth\Model\RespondToSignInChallengeParam::class => false, \AntiPatternInc\Saasus\Sdk\Auth\Model\RespondToSignInChallengeResult::class => false, \AntiPatternInc\Saasus\Sdk\Auth\Model\NewDeviceMetadata::class => false, \AntiPatternInc\Saasus\Sdk\Auth\Model\DeviceSecretVerifierConfig::class => false, \AntiPatternInc\Saasus\Sdk\Auth\Model\ConfirmDeviceParam::class => false, \AntiPatternInc\Saasus\Sdk\Auth\Model\ConfirmDeviceResult::class => false, \AntiPatternInc\Saasus\Sdk\Auth\Model\UpdateDeviceStatusParam::class => false, \Jane\Component\JsonSchemaRuntime\Reference::class => false];
        }
    }
} else {
    class JaneObjectNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
