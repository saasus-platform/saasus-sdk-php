...
if (!class_exists(Kernel::class) or (Kernel::MAJOR_VERSION >= 7 or Kernel::MAJOR_VERSION === 6 and Kernel::MINOR_VERSION === 4)) {
    class UpdateNotificationMessagesParamNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
    {
        ...
        {
            return $type === \AntiPatternInc\Saasus\Sdk\Auth\Model\UpdateNotificationMessagesParam::class;
        }
        public function supportsNormalization(mixed $data, string $format = null, array $context = []): bool
        {
            return is_object($data) && get_class($data) === AntiPatternInc\Saasus\Sdk\Auth\Model\UpdateNotificationMessagesParam::class;
        }
        public function denormalize(mixed $data, string $type, string $format = null, array $context = []): mixed
        {
            ...
            if (\array_key_exists('sign_up', $data) && $data['sign_up'] !== null) {
                $object->setSignUp($this->denormalizer->denormalize($data['sign_up'], \AntiPatternInc\Saasus\Sdk\Auth\Model\MessageTemplate::class, 'json', $context));
                unset($data['sign_up']);
            }
            ...
            if (\array_key_exists('create_user', $data) && $data['create_user'] !== null) {
                $object->setCreateUser($this->denormalizer->denormalize($data['create_user'], \AntiPatternInc\Saasus\Sdk\Auth\Model\MessageTemplate::class, 'json', $context));
            ...
            if (\array_key_exists('resend_code', $data) && $data['resend_code'] !== null) {
                $object->setResendCode($this->denormalizer->denormalize($data['resend_code'], \AntiPatternInc\Saasus\Sdk\Auth\Model\MessageTemplate::class, 'json', $context));
            ...
            if (\array_key_exists('forgot_password', $data) && $data['forgot_password'] !== null) {
                $object->setForgotPassword($this->denormalizer->denormalize($data['forgot_password'], \AntiPatternInc\Saasus\Sdk\Auth\Model\MessageTemplate::class, 'json', $context));
            ...
            if (\array_key_exists('update_user_attribute', $data) && $data['update_user_attribute'] !== null) {
                $object->setUpdateUserAttribute($this->denormalizer->denormalize($data['update_user_attribute'], \AntiPatternInc\Saasus\Sdk\Auth\Model\MessageTemplate::class, 'json', $context));
            ...
            if (\array_key_exists('verify_user_attribute', $data) && $data['verify_user_attribute'] !== null) {
                $object->setVerifyUserAttribute($this->denormalizer->denormalize($data['verify_user_attribute'], \AntiPatternInc\Saasus\Sdk\Auth\Model\MessageTemplate::class, 'json', $context));
            ...
            if (\array_key_exists('authentication_mfa', $data) && $data['authentication_mfa'] !== null) {
                $object->setAuthenticationMfa($this->denormalizer->denormalize($data['authentication_mfa'], \AntiPatternInc\Saasus\Sdk\Auth\Model\MessageTemplate::class, 'json', $context));
            ...
            if (\array_key_exists('invite_tenant_user', $data) && $data['invite_tenant_user'] !== null) {
                $object->setInviteTenantUser($this->denormalizer->denormalize($data['invite_tenant_user'], \AntiPatternInc\Saasus\Sdk\Auth\Model\MessageTemplate::class, 'json', $context));
            ...
            if (\array_key_exists('verify_external_user', $data) && $data['verify_external_user'] !== null) {
                $object->setVerifyExternalUser($this->denormalizer->denormalize($data['verify_external_user'], \AntiPatternInc\Saasus\Sdk\Auth\Model\MessageTemplate::class, 'json', $context));
        ...
        {
            return [\AntiPatternInc\Saasus\Sdk\Auth\Model\UpdateNotificationMessagesParam::class => false];
        }
    }
} else {
    class UpdateNotificationMessagesParamNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
