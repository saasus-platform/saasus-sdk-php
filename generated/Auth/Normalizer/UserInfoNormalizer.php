...
class UserInfoNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === 'AntiPatternInc\\Saasus\\Sdk\\Auth\\Model\\UserInfo';
    }
    public function supportsNormalization($data, $format = null, array $context = array()) : bool
    {
        return is_object($data) && get_class($data) === 'AntiPatternInc\\Saasus\\Sdk\\Auth\\Model\\UserInfo';
    }
    /**
     * @return mixed
     */
    public function denormalize($data, $class, $format = null, array $context = array())
    {
        ...
        if (\array_key_exists('tenants', $data) && $data['tenants'] !== null) {
            ...
            foreach ($data['tenants'] as $value) {
                $values[] = $this->denormalizer->denormalize($value, 'AntiPatternInc\\Saasus\\Sdk\\Auth\\Model\\UserAvailableTenant', 'json', $context);
            }
    ...
    {
        return array('AntiPatternInc\\Saasus\\Sdk\\Auth\\Model\\UserInfo' => false);
    }
}