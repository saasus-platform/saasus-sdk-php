...
class UserNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === 'AntiPatternInc\\Saasus\\Sdk\\Communication\\Model\\User';
    }
    public function supportsNormalization($data, $format = null, array $context = array()) : bool
    {
        return is_object($data) && get_class($data) === 'AntiPatternInc\\Saasus\\Sdk\\Communication\\Model\\User';
    }
    /**
     * @return mixed
     */
    ...
    {
        return array('AntiPatternInc\\Saasus\\Sdk\\Communication\\Model\\User' => false);
    }
}