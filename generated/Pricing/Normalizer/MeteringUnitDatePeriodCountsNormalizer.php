...
class MeteringUnitDatePeriodCountsNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === 'AntiPatternInc\\Saasus\\Sdk\\Pricing\\Model\\MeteringUnitDatePeriodCounts';
    }
    public function supportsNormalization($data, $format = null, array $context = array()) : bool
    {
        return is_object($data) && get_class($data) === 'AntiPatternInc\\Saasus\\Sdk\\Pricing\\Model\\MeteringUnitDatePeriodCounts';
    }
    /**
     * @return mixed
     */
    public function denormalize($data, $class, $format = null, array $context = array())
    {
        ...
        if (\array_key_exists('counts', $data) && $data['counts'] !== null) {
            ...
            foreach ($data['counts'] as $value) {
                $values[] = $this->denormalizer->denormalize($value, 'AntiPatternInc\\Saasus\\Sdk\\Pricing\\Model\\MeteringUnitCount', 'json', $context);
            }
    ...
    {
        return array('AntiPatternInc\\Saasus\\Sdk\\Pricing\\Model\\MeteringUnitDatePeriodCounts' => false);
    }
}