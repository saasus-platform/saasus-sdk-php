...
if (!class_exists(Kernel::class) or (Kernel::MAJOR_VERSION >= 7 or Kernel::MAJOR_VERSION === 6 and Kernel::MINOR_VERSION === 4)) {
    class PricingUsageUnitForSaveNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
    {
        ...
        {
            return $type === \AntiPatternInc\Saasus\Sdk\Pricing\Model\PricingUsageUnitForSave::class;
        }
        public function supportsNormalization(mixed $data, string $format = null, array $context = []): bool
        {
            return is_object($data) && get_class($data) === AntiPatternInc\Saasus\Sdk\Pricing\Model\PricingUsageUnitForSave::class;
        }
        public function denormalize(mixed $data, string $type, string $format = null, array $context = []): mixed
        {
            ...
            $object = new \AntiPatternInc\Saasus\Sdk\Pricing\Model\PricingUsageUnitForSave();
        ...
        {
            return [\AntiPatternInc\Saasus\Sdk\Pricing\Model\PricingUsageUnitForSave::class => false];
        }
    }
} else {
    class PricingUsageUnitForSaveNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
